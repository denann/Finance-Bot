...
| Category | Add and edit categories | Lets users add or edit category type, symbol, and aliases. New aliases can be generated by Gemini and are previewed before saving. |
...
| Reporting | Monthly charts | Sends SVG line, bar, or pie charts for monthly net expense trends and category breakdowns. |
