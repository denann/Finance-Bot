...
def _add(status: str, title: str, detail: str = ""):
    """Helper for add in the developer utility script."""
...
def mask(value: str) -> str:
    """Helper for mask in the developer utility script."""
    value = str(value or "")
    if len(value) <= 10:
...
def env(name: str, default: str = "") -> str:
    """Helper for env in the developer utility script."""
    return str(os.getenv(name, default) or "").strip()


def check_env_file():
    """Helper for check env file in the developer utility script."""
...
def check_runtime_env() -> str:
    """Helper for check runtime env in the developer utility script."""
...
def check_service_account_file():
    """Helper for check service account file in the developer utility script."""
...
def check_google_sheets_schema(can_try: bool):
    """Helper for check google sheets schema in the developer utility script."""
