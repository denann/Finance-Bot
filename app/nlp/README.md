...
- `gemini_langchain_client.py`: governed LangChain/Gemini client construction and invocation.
...
- `gemini_category_aliases.py`: AI-assisted category alias suggestions before user confirmation.
